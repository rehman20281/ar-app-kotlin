...
import com.app.ardeco.components.Card1
import com.app.ardeco.utils.ModelViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun SavedDesign(navController: NavController, page: String?) {
    ...
    val modelData by viewModel.savedDesignData.collectAsState(initial = emptyList())
    ...
    LaunchedEffect(page) {
        if (page != null) {
            viewModel.fetchSavedDesigns("https://tgali.com/ardeco/ardeco/api/v1/saved-design/${_userId}", "saved_${_userId}")
        }
    }
                    ...
                    LazyVerticalGrid(
                        ...
                        items(modelData.size) { index ->
                            ...
                            Card1(
                                ...
                                id = modelItem.id,
                                modelImage = modelItem.image,
                                file = modelItem.model,
